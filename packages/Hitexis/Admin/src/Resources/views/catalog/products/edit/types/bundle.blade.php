        ...
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            >
                <form @submit="handleSubmit($event, updateOrCreate)">
                    ...
                    <hitexis-admin::modal ref="updateCreateOptionModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                        ...
                        <x-slot:content>
                            <hitexis-admin::form.control-group>
                                ...
                                <hitexis-admin::form.control-group.error control-name="label" />
                            </hitexis-admin::form.control-group>
                            ...
                            <div class="flex gap-4">
                                <hitexis-admin::form.control-group class="flex-1">
                                    ...
                                    <hitexis-admin::form.control-group.error control-name="type" />
                                </hitexis-admin::form.control-group>
                                ...
                                <hitexis-admin::form.control-group class="flex-1">
                                    ...
                                    <hitexis-admin::form.control-group.error control-name="is_required" />
                                </hitexis-admin::form.control-group>
                            </div>
                        </x-slot>
                    ...
                    <template #item="{ element, index }">
                        <div class="flex justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            ...
                            <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                ...
                                <hitexis-admin::form.control-group class="!mb-0">
                                    <hitexis-admin::form.control-group.label class="required !block">
