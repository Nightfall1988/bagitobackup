...
@pushOnce('scripts')
        ...
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            >
                <form @submit="handleSubmit($event, addVariant)">
                    ...
                    <hitexis-admin::modal ref="variantCreateModal">
                        <!-- Modal Header -->
                        <x-slot:header>
                        ...
                        <!-- Modal Content -->
                        <x-slot:content>
                            <hitexis-admin::form.control-group
                                v-for='(attribute, index) in superAttributes'
                            >
                                <hitexis-admin::form.control-group.label class="required">
                                    @{{ attribute.admin_name }}
                                </hitexis-admin::form.control-group.label>
    ...
    >
        ...
        <div class="flex items-center gap-1.5 px-4">
            ...
            <hitexis-admin::dropdown v-bind:close-on-click="false">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <button
                        type="button"
            ...
            </hitexis-admin::dropdown>

            <!-- Actions Selector -->
            <hitexis-admin::dropdown v-if="selectedVariants.length">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <button
                        type="button"
                ...
                <!-- Dropdown Content -->
                <x-slot:menu>
                    <hitexis-admin::dropdown.menu.item
                    ...
                    >
                        ...
                        <x-slot:content class="p-4">
                                ...
                                <form @submit="handleSubmit($event, update)">
                                    ...
                                    <template v-if="selectedType == 'editPrices'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            <div class="flex items-end gap-2.5">
                                                <hitexis-admin::form.control-group class="!mb-0 flex-1">
                                                    <hitexis-admin::form.control-group.label>
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <hitexis-admin::form.control-group.control
                                                            type="text"
                                            ...
                                            <hitexis-admin::form.control-group.error control-name="price" />
                                        </div>
                                    </template>
                                    ...
                                    <template v-if="selectedType == 'editWeight'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            ...
                                            <hitexis-admin::form.control-group.error control-name="weight" />
                                        </div>
                                    </template>
                                    ...
                                    <template v-if="selectedType == 'editName'">
                                        <div class="border-b pb-2.5 dark:border-gray-800">
                                            ...
                                            <hitexis-admin::form.control-group.error control-name="name" />
                                        </div>
                                    </template>
                            ...
                            >
                                ...
                                <template v-if="selectedType == 'editPrices'">
                                    <hitexis-admin::form.control-group class="mb-0 max-w-[115px] flex-1">
                                        <div class="relative">
                                            <span class="absolute top-1/2 -translate-y-1/2 text-gray-500 ltr:left-4 rtl:right-4">
                                                {{ core()->currencySymbol(core()->getBaseCurrencyCode()) }}
                                            </span>
                                ...
                                <template v-if="selectedType == 'editInventories'">
                                    <hitexis-admin::form.control-group class="mb-0 mt-2.5">
                                        <div class="mb-2.5 grid grid-cols-3 gap-4">
                                            <hitexis-admin::form.control-group
                                                class="!mb-0"
                                                v-for='inventorySource in inventorySources'
                                ...
                                >
                                    ...
                                    <x-slot:content>
                                        ...
                                        <hitexis-admin::form.control-group>
                                            ...
                                            <hitexis-admin::form.control-group.error control-name="sku" />
                                        </hitexis-admin::form.control-group>

                                        <div class="mb-2.5 flex gap-4">
                                            <hitexis-admin::form.control-group class="flex-1">
                                                <hitexis-admin::form.control-group.label class="required">
                                            ...
                                            <hitexis-admin::form.control-group class="flex-1">
                                                ...
                                                <hitexis-admin::form.control-group.error control-name="status" />
                                            </hitexis-admin::form.control-group>
                                        </div>
