...
namespace Hitexis\Product\Helpers;

use Hitexis\Product\Facades\ProductImage;
use Hitexis\Product\Facades\ProductVideo;
...
class ConfigurableOption
{
     ...
     *
     * @param  \Hitexis\Product\Contracts\Product  $currentProduct
     ...
     *
     * @param  \Hitexis\Attribute\Contracts\Attribute  $attribute
     * @param  array  $options
     * @return array
     */
