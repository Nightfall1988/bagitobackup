...
namespace Hitexis\CartRule\Helpers;

use Carbon\Carbon;
use Illuminate\Database\Eloquent\Builder;
use Hitexis\CartRule\Repositories\CartRuleCouponRepository;
use Hitexis\CartRule\Repositories\CartRuleCouponUsageRepository;
use Hitexis\CartRule\Repositories\CartRuleCustomerRepository;
use Hitexis\CartRule\Repositories\CartRuleRepository;
...
class CartRule
{
     ...
     *
     * @param  \Hitexis\CartRule\Contracts\CartRule  $rule
     */
    public function canProcessRule($rule): bool
    {
        if ($rule->coupon_type) {
            ...
            /** @var \Hitexis\CartRule\Models\CartRule $rule */
